 ...
 * @author MARK
 */
public class FunctionSearchParametersFX {
  ...
  // Image searchImg= Toolkit.getDefaultToolkit().getImage(getClass().getResource("/com/solutions/main/utilities/icons/search32.png"));
     ...
     public static JDialog showSearchDialogXY(JTable jtable,JFrame parent,int WIDTH,int HEIGHT){
...
//         y_coordinate = y_coordinate+ relative.getLocation().y;
       ...
       jinf.add(jpanels);
    //  jinf.setIconImage(new FunctionSearchParametersFX().searchImg);
    return jinf;
    }
}
