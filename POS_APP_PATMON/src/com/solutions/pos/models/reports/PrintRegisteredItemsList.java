 ...
 * @author shaddie
 */
public class PrintRegisteredItemsList {
    ...
    public static void generateReport(TableView table_to_export, String path, String title) {
        ...
        String columnNames[] = {"ID", "SKU Name", "Category"};
       ...
       writer.setPageEvent((PdfPageEvent) new WaterMarkGenerator());
            ...
            RegisteredItemsReport record;
            for (Object dailySales : list) {
                record = (RegisteredItemsReport) dailySales;
                ...
                table.addCell(new Phrase("" + record.getSkuCategoryName(), FontFactory.getFont("Helvetica", 11.0F)));
            }
            document.add(table);
            document.add(new Phrase("\n"));
